...
class InddController extends Controller
{
    public function dashBoard() {
    	...
    	return view('inddteam.dashboard', compact('book', 'chapter', 'client'));
    }

    public function jobsList() {
    	$jobs = CopyEditing::getJobs();
    	return view('inddteam.joblist', compact('jobs'));
    }

    public function jobChapter($bookid) {
    	$chapter = CopyEditing::getAllChapter($bookid);
    	$ceusers = CopyEditing::getCopyEditingUsers();
        return view('inddteam.chapterlist', compact('chapter', 'ceusers'));
    }
