...
class XMLController extends Controller
{
    public function dashBoard() {
    	...
    	return view('xmlteam.dashboard', compact('book', 'chapter', 'client','myjobs','jobs'));
    }

    public function jobsList() {
    	$jobs = CopyEditing::getJobs();
    	return view('xmlteam.joblist', compact('jobs'));
    }
    ...
    public function jobChapter($bookid) {
        ...
        return view('xmlteam.chapterlist', compact('chapter', 'ceusers','jobtype'));
    }
