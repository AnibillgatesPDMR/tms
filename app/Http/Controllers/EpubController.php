...
class EpubController extends Controller
{
    public function dashBoard() {
    	...
    	return view('epubteam.dashboard', compact('book', 'chapter', 'client'));
    }

    public function jobsList() {
    	$jobs = CopyEditing::getJobs();
    	return view('epubteam.joblist', compact('jobs'));
    }

    public function jobChapter($bookid) {
    	$chapter = CopyEditing::getAllChapter($bookid);
    	$ceusers = CopyEditing::getCopyEditingUsers();
        return view('epubteam.chapterlist', compact('chapter', 'ceusers'));
    }
