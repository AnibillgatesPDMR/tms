...
?>
        ...
        <div class="modal-dialog" role="document">
            {!! Form::open(['method' => 'post', 'url' => 'chapter/create']) !!}

            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                    <h4 class="modal-title" id="roleModalLabel">Chapter</h4>
                </div>
                <div class="modal-body">
                    ...
                    <div class="form-group @if ($errors->has('name')) has-error @endif">
                        ...
                        {!! Form::text('name', null, ['class' => 'form-control', 'placeholder' => 'Chapter', 'required' => 'required']) !!}
    ...
    <div class="row">
        <div class="col-md-5">
            <h3 class="modal-title">{{ Str::plural('Chapter', $result->count()) }} </h3>
        </div>
        ...
        <div class="col-md-7 page-action text-right">
            ...
            @can('add_clients')
                <a href="#" class="btn btn-sm btn-success pull-right" data-toggle="modal" data-target="#roleModal"> <i class="glyphicon glyphicon-plus"></i> Add Chapter</a>
            @endcan
        </div>
    </div>
