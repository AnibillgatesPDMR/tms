...
<body class="hold-transition skin-blue sidebar-mini">
                  ...
                  <li class="dropdown user user-menu">
                    ...
                    <ul class="dropdown-menu">
                      ...
                      <li class="user-footer">
                        <div class="pull-left">
                        <?php $url = "change_password"; ?>
                          <a href="{{ asset($url) }}" class="btn btn-default btn-flat">Change Password</a>
                        </div>
          ...
          <aside class="main-sidebar">
            ...
            <section class="sidebar">
              ...
              <ul class="sidebar-menu" data-widget="tree">
               ...
               <?php if(Auth::user()->role==17) { ?>
                  <li class="{{ Request::is('users*') ? 'active' : '' }}">
                    <a href="{{ asset('users/add/user') }}"><i class="fa fa-user"></i><span>Users</span></a>
                  </li>
               <?php } ?>
                @can('view_roles')
                ...
                @endcan
                @can('view_holidays')
                  <li class="{{ Request::is('holidays*') ? 'active' : '' }}" style='display:none;'>
                    <a  href="{{ asset('holidays') }}"><i class="fa fa-bell-slash"></i> <span>Bank/Public Holidays</span></a>
                  </li>
                @endcan

               
                <li class="{{ Request::is('attentance*') ? 'active' : '' }}" style='display:block;'>
                    <a href="{{ asset('attentance') }}"><i class="fa fa-file"></i> <span>Attendance Details</span></a>
                  </li>
                 


                <li class="{{ Request::is('departmentlist') ? 'active' : '' }}">
                    <a href="{{ asset('addbreakinghours') }}"><i class="fa fa-clock-o" aria-hidden="true"></i> <span>Add Break Time</span></a>
                  </li>
                @can('view_working_hours')
                  <li class="{{ Request::is('trackingworkinghours*') ? 'active' : '' }}" style='display:none;'>
                    <a href="{{ asset('trackingworkinghours') }}"><i class="fa fa-bell"></i> <span>Login History Hours</span></a>
                  </li>
                @endcan
                <?php if(Auth::user()->role==17) { ?>
                ...
                @can('view_forget_login')
                  <li class="{{ Request::is('forgetlogin*') ? 'active' : '' }}">
                    <a href="{{ asset('forgetlogin') }}"><i class="fa fa-hand-pointer-o"></i> <span>Forgot login</span></a>
                  </li>
                @endcan
                @can('view_request_time_off')
                  <li class="{{ Request::is('leavedashboard*') ? 'active' : '' }}">
                    <a href="{{ asset('leavedashboard') }}"><i class="fa fa-power-off" aria-hidden="true"></i> <span>Leave Requests</span></a>
                  </li>
                @endcan
                <?php if(Auth::user()->role==17) { ?>
                  <li class="{{ Request::is('departmentlist') ? 'active' : '' }}">
                ...
                <li class="{{ Request::is('departmentlist') ? 'active' : '' }}">
                    <a href="{{ asset('leavebalance') }}"><i class="fa fa-power-off" aria-hidden="true"></i> <span>Leave Balance</span></a>
                  </li>


                <li class="{{ Request::is('departmentlist') ? 'active' : '' }}" style='display:none;'>
                    <a href="#"><i class="fa fa-question" aria-hidden="true"></i> <span>FAQ</span></a>
                  </li>

                  <li class="{{ Request::is('departmentlist') ? 'active' : '' }}">
                    <a href="{{ asset('tickets') }}"><i class="fa fa-ticket" aria-hidden="true"></i> <span>Tickets</span></a>
   ...
   <script src="https://cdnjs.cloudflare.com/ajax/libs/jqueryui/1.12.1/jquery-ui.min.js">
    </script><script src="https://cdnjs.cloudflare.com/ajax/libs/moment.js/2.18.1/moment.min.js">
    </script><script src="https://cdnjs.cloudflare.com/ajax/libs/fullcalendar/3.4.0/fullcalendar.min.js"></script>
