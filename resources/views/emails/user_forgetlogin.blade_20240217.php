...
<p>  Please approve this request in the TMS as soon as possible. <a href="{{ asset('forgetlogin_accept_via_email') }}/{{ $users['datas']['data-forget_id']  }}" target='_blank'>Accept</a></p>
