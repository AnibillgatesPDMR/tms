...
<p>Your request for {{ $users['datas']['data-leavetype'] }} from {{ $users['datas']['data-from_date'] }} to {{ $users['datas']['data-to_date'] }} is approved. Your TMS leave record has been updated accordingly. </p>
...
<p style='color:red;'>Note : This Employee Cancel the leave </p>
