...
?>
    <div class="row">
        ...
        <div class="col-md-1 page-action text-right">
        	<a href="{{ asset('pre/jobs/list') }}" style="margin-right: 10px;" class="btn btn-danger btn-sm"> <i class="fa fa-arrow-left"></i> Back</a>
        </div>
    </div>
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group @if ($errors->has('duedate')) has-error @endif">
                        ...
                        <div class="input-group col-md-12 date">
                            <input type="text" name="duedate" class="form-control pull-right" id="preduedate" required="required">
