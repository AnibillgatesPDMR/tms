...
// Route::get('/home', HomeController::class);
    ...
    Route::post('tickets/add/ticket', 'UserController@ticket_list');
...
Route::get('tickets/{id}/edit', 'UserController@ticketEdit'); 

Route::post('tickets/updateticket', 'UserController@updatetikcets'); 
    ...
    Route::post('leave/insertleave', 'UserController@leavestore'); 
    ...
    Route::get('leavelistdeatils_ajax', 'UserController@leavelistdeatils_ajax'); 


    Route::get('withdrawleave', 'UserController@userleave_withdraw'); 


    Route::get('get_Leaves_bymonth_ajax', 'UserController@all_leaves_bymonth_ajax'); 

    

    Route::get('leave/getbankholidays', 'UserController@getbankholidays_count'); 
...
Route::get('leave_approve_via_email/{id}', 'UserController@leave_approve_via_email'); 

Route::get('leave_reject_via_email/{id}', 'UserController@leave_reject_via_email'); 

Route::get('forgetlogin_accept_via_email/{id}', 'UserController@forgetlogin_accept_via_email'); 

Route::get('forgetlogin_reject_via_email/{id}', 'UserController@forgetlogin_reject_via_email'); 
